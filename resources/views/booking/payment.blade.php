...
<section id="Content" class="w-full max-w-[1280px] mx-auto px-[52px] mt-16 mb-[100px]">
    <div class="flex flex-col gap-16">
        ...
        <main class="flex gap-8">
            ...
            <form id="Form" enctype="multipart/form-data" action="{{ route('front.payment_store') }}" class="flex flex-col w-[724px] gap-8">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col rounded-xl border border-[#E6E7EB] p-5 gap-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <p class="font-semibold text-lg leading-[27px] text-right">
                                    Rp
                                    {{ number_format($orderData['price'], 0, ',', '.') }}
                                </p>
                            </div>
                            <div class="flex items-center justify-between">
                                ...
                                <p class="font-semibold text-lg leading-[27px] text-right">
                                    Rp
                                    {{ number_format($orderData['total_tax'], 0, ',', '.')}}
                                </p>
                            </div>
                        ...
                        <div class="flex flex-col gap-6">
                            <label class="flex flex-col gap-4">
                                ...
                                <div class="group input-wrapper flex items-center rounded-xl p-4 gap-2 bg-[#FBFBFB] overflow-hidden">
                                    ...
                                    <input type="text" name="custumer_bank_name" id="bankname" class="appearance-none bg-transparent w-full outline-none text-lg leading-[27px] font-semibold placeholder:font-medium placeholder:text-aktiv-grey" placeholder="What is the name of the bank you use?" required>
                                </div>
                            </label>
                            <label class="flex flex-col gap-4">
                                ...
                                <div class="group input-wrapper flex items-center rounded-xl p-4 gap-2 bg-[#FBFBFB] overflow-hidden">
                                    ...
                                    <input type="text" name="custumer_bank_account" id="fullname" class="appearance-none bg-transparent w-full outline-none text-lg leading-[27px] font-semibold placeholder:font-medium placeholder:text-aktiv-grey" placeholder="Under whose name is this bank account?" required>
                                </div>
                            </label>
                            <label class="flex flex-col gap-4">
                                ...
                                <div class="group input-wrapper flex items-center rounded-xl p-4 gap-2 bg-[#FBFBFB] overflow-hidden">
                                    ...
                                    <input type="text" name="custumer_bank_number" id="banknumber" class="appearance-none bg-transparent w-full outline-none text-lg leading-[27px] font-semibold placeholder:font-medium placeholder:text-aktiv-grey" placeholder="What is the bank account number?" required>
                                </div>
                            </label>
                        </div>
                    </div>
